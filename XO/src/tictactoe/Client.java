...
import tictactoe.controllerrs.GameController;
import tictactoe.exceptions.InvalidBotCountException;
import tictactoe.exceptions.InvalidMoveException;
import tictactoe.exceptions.InvalidNumberOfPlayersException;
import tictactoe.models.*;
import tictactoe.strategies.winingstrategies.ColWinningStrategy;
import tictactoe.strategies.winingstrategies.DiagonalRowWinningStrategy;
import tictactoe.strategies.winingstrategies.GameWinningStrategy;
import tictactoe.strategies.winingstrategies.RowWinningStrategy;
...
public class Client {
    public static void main(String[] args) throws InvalidBotCountException, InvalidNumberOfPlayersException, InvalidMoveException {
        ...
        List<Player> players = List.of(
                new Player("Chetan", new Symbol('X')),
                new Player("Dev", new Symbol('O'))
        );
